...
exports.default = Component({
    relations: _WxHelper.getChildRelation(ChildPath),
    behaviors: [],
    properties: {
        index: {
            type: Number | String,
    ...
    methods: {
        ...
        _initRect: function _initRect() {
            ...
            _WxHelper.getComponentRect(this, '.ui-tabs').then(function(rect) {
                _this.setData({
                    rect: rect
                });
            });
        ...
        _initSelfInkBarStyle: function _initSelfInkBarStyle() {
            this.setData({
                selfInkBarStyle: _StyleHelper.getPlainStyle(this.data.inkBarStyle)
            });
        },
        handleIndexChange: function handleIndexChange(index, outerChange) {
            _MultiHelper.updateChildActive(this, index);
        ...
        _setTabStyle: function _setTabStyle() {
            ...
            var style = _StyleHelper.getPlainStyle(tabStyle);
            var activeStyle = _StyleHelper.getMergedPlainStyles([tabStyle, activeTabStyle]);
        ...
        _autoCenterTab: function _autoCenterTab() {
            ...
            _WxHelper.getScrollViewRect(this, '.ui-tabs').then(function(scrollRect) {
                _WxHelper.getComponentRect(child, '.ui-tab').then(function(rect) {
        ...
        _setInkBarWrapperStyle: function _setInkBarWrapperStyle() {
            ...
            this.setData({
                inkBarWrapperStyle: _StyleHelper.getPlainStyle({
                    top: rect.height - 2,
                    left: left,
                    width: width
                })
        ...
        _increaseWalkDistance: function _increaseWalkDistance(rect) {
            ...
            if (this.data.walkCount === this.data.children.length) {
                ...
                var style = _StyleHelper.getMergedPlainStyles([tabStyle, fixedStyle]);
                var activeStyle = _StyleHelper.getMergedPlainStyles([tabStyle, activeTabStyle, fixedStyle]);
